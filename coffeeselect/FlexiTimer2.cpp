...
void (*FlexiTimer2::func)(void* arg);
volatile unsigned long FlexiTimer2::count;
volatile char FlexiTimer2::overflowing;
volatile unsigned int FlexiTimer2::tcnt2;
void* pthis;

void FlexiTimer2::set(unsigned long ms,  void (*f)(void *arg),void *arg) {
    FlexiTimer2::set(ms, 0.001, f,arg);
}
 ...
 */
void FlexiTimer2::set(unsigned long units, double resolution, void (*f)(void *arg),void *arg) {
	float prescaler = 0.0;
